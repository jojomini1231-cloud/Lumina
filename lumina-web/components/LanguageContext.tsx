  ...
  zh: {
    ...
    settings: {
      ...
      tokens: {
        ...
        quota: '限额',
        requestLimit: '请求限制',
        concurrencyLimit: 'API 请求并发量（次/秒）',
        resetRequestLimit: '重置请求限制',
        resetRequestLimitConfirm: '确定要重置此令牌的请求限制计数吗？重置后该 key 的已用请求数会从 0 重新计算。',
        resetRequestLimitConfirmAction: '确认重置',
        modelLimit: '模型限制',
        allModels: '全部模型',
        noModelGroups: '暂无模型分组',
        modelLimitSummary: '已绑定 {{count}} 个模型',
        unlimited: '无限制',
        editQuota: '编辑限额',
        editSettings: '编辑设置',
        setQuota: '设置',
        quotaUpdated: '令牌限额已更新',
        requestLimitReset: '请求限制已重置',
        invalidQuota: '限额必须是大于等于 0 的数字',
        invalidRequestLimit: '请求限制必须是大于等于 0 的整数',
        invalidConcurrencyLimit: 'API 请求并发量必须是大于等于 0 的整数',
        expires: '过期时间',
        neverExpires: '永不过期',
        expired: '已过期',
        enable: '启用',
  ...
  en: {
    ...
    settings: {
      ...
      tokens: {
        ...
        key: 'Secret Key',
        group: 'Group',
        searchPlaceholder: 'Search token name or key',
        created: 'Created',
        lastUsed: 'Last Used',
        ...
        concurrencyLimit: 'API request concurrency (req/sec)',
        resetRequestLimit: 'Reset request limit',
        resetRequestLimitConfirm: 'Reset the request limit usage counter for this token? After reset, this key starts counting used requests from 0 again.',
        resetRequestLimitConfirmAction: 'Confirm reset',
        modelLimit: 'Model limit',
        allModels: 'All models',
        noModelGroups: 'No model groups',
        modelLimitSummary: '{{count}} models bound',
        unlimited: 'Unlimited',
        editQuota: 'Edit quota',
        editSettings: 'Edit settings',
        setQuota: 'Set',
        quotaUpdated: 'Token quota updated',
        requestLimitReset: 'Request limit reset',
        invalidQuota: 'Quota must be a number greater than or equal to 0',
        invalidRequestLimit: 'Request limit must be an integer greater than or equal to 0',
        invalidConcurrencyLimit: 'API request concurrency must be an integer greater than or equal to 0',
        expires: 'Expires',
        neverExpires: 'Never',
        expired: 'Expired',
        enable: 'Enable',
